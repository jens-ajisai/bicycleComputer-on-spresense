...
//#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_notosans_j_16)

/*Always set a default font*/
//#define LV_FONT_DEFAULT &lv_font_notosans_j_16

#define LV_FONT_CUSTOM_DECLARE extern lv_font_t* my_font;
